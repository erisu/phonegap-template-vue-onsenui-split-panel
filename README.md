# OnsenUI PhoneGap template using Vue.js that degrades to a Panel View on smaller devices

Vue.js, OnsenUI, and Cordova / PhoneGap Template with Babel, Webpack and Hot Reloading
...
```
cordova create MyAppName --template=phonegap-template-vue-onsenui-split-panel
```

or

```
phonegap create MyAppName --template phonegap-template-vue-onsenui-split-panel
```
